...
# === Definizione dei percorsi relativi ===
base_dir = Path(__file__).parent
age_file = base_dir / "mimiciv_3_1_derived_export_age_data.csv"
acei_file = base_dir / "mimiciv_3_1_derived_export_acei_data.csv"

# === Caricamento file ===
# Carica i due file MIMIC reali
df_age = pd.read_csv(age_file)
df_acei = pd.read_csv(acei_file)
...
print(f"Entropy (sample level): {entropy(probs, base=2):.4f}")
